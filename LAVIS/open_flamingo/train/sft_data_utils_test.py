...
if __name__ == "__main__":
    ...
    text_tokenizer.add_special_tokens({"additional_special_tokens": list(special_tokens.values())})
    ...
    train_dataset, total_num_samples = make_supervised_data_module(
        tokenizer=text_tokenizer, image_processor=image_processor, data_args=args
    )
